...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https:http://youtube.com/channel/UC568LJONA5IIi2uTSKUYE-g
    else:
        print "\033[1;94mWrong Username"
        os.system('xdg-open https:http://youtube.com/channel/UC568LJONA5IIi2uTSKUYE-g-g')
